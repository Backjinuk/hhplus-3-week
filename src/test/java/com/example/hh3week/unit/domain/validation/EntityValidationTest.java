package com.example.hh3week.unit.domain.validation;
...
import com.example.hh3week.domain.validation.EntityValidation;
...
class EntityValidationTest {
	...
	void 대기열_queue가_vadlidation_정상_토과() {
		...
		assertThat(waitingQueue.getSeatDetailId()).isEqualTo(1);
